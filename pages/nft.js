...
export default function GenerateNFT() {
    ...
    let contract;
    chain?.id == 137 ? contract = nftGeneratorAddress.polygon
        : chain?.id == 42161 ? contract = nftGeneratorAddress.arbitrum
            : chain?.id == 5 ? contract = nftGeneratorAddress.goerli
                : '';
    ...
    function LinkToExplorer() {
        ...
        chain?.id == 137 ? explorer = 'https://polygonscan.com'
            : chain?.id == 42161 ? explorer = 'https://arbiscan.io'
                : chain?.id == 5 ? explorer = 'https://goerli.etherscan.io'
                    : '';
        const link = explorer + '/tx/' + data.hash;
        return (<a href={link} className="text-blue-600 hover:underline">{link}</a>)
    }
                ...
                <section className="flex justify-center mb-3">
                    <div className="mt-8 mb-3 w-96 text-center">
                        ...
                        />
                        {
                            fileUrl && (
                                // convert to <Image> !!!
                                <img className="mt-8 rounded-md" fill="true" alt="Uploaded IPFS Image" src={fileUrl} />
                            )
                        }
                    </div>
                </section>
                ...
                <section className="items-center">
                    <div className="mt-8 mb-3 text-center">
                        ...
                        <div>
                            ...
                            {isSuccess &&
                                <div className="text-sm text-gray-700">Transaction: {LinkToExplorer()}
                                    <p href="https://opensea.io/" className="mt-3 cursor-pointer text-xs text-blue-600 hover:underline">Check out your NFT with OpenSea!</p>
                                </div>}
